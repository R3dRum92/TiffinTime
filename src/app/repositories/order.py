...
#         "menu": str(order_data.menu_id),  # Column name is 'menu' in your schema
#         "order_date": datetime.now().isoformat(),
#         "Quantity": order_data.quantity,  # Capital Q
#         "unit price": order_data.unit_price,  # Space in column name
#         "total price": total_price,  # Space in column name
...
#                     quantity=order.get("Quantity"),  # Capital Q
#                     unit_price=order.get("unit price"),  # Space in column name
#                     total_price=order.get("total price"),  # Space in column name
