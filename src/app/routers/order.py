...
# ):
#     """Create a new order"""
#     return await orders.create_order(client=client, order_data=order_data)
...
#     return await orders.get_user_orders(client=client, user_id=user_id)
...
async def create_order(
    ...
    """Create a new order"""
    return await order.create_order(client=client, order_data=order_data)
